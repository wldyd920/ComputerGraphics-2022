...
while not done:   
    ...
    if old_pressed == -1 and pressed == 1 and old_button1 == 1 and button1 == 0 :
        ...
        pygame.draw.circle(screen, WHITE, pt, 1)
        print("len:"+repr(len(pts))+" mouse x:"+repr(x)+" y:"+repr(y)+" button:"+repr(button1)+" pressed:"+repr(pressed)+" add pts ...")

    elif old_pressed == -3 and pressed == 3 and old_button3 == 1 and button3 == 0 :
        pts = [] 
        knots = []
        count = 0
        screen.fill(WHITE)
        print("len:"+repr(len(pts))+" mouse x:"+repr(x)+" y:"+repr(y)+" button:"+repr(button1)+" pressed:"+repr(pressed)+" erase")
