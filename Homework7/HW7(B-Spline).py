...
while not done:   
    ...
    if old_button1 == 0 and button1 == 1:
        ...
        # for i in range(len(knot_index)):
        #     if knot_index[i] != (len(pts)-1): 
        #         if i == 0:
        #             tmp = pts[0:knot_index[i]]
        #         elif len(knot_index)-1 > i > 0:
        #             tmp = pts[knot_index[i]:knot_index[i+1]]
        #         elif i != 0 and i == len(knot_index)-1:
        #             tmp = pts[knot_index[i]:-1]
        #     elif knot_index[i] == len(pts):
        #         pass
        #     tmp_pts.append(tmp)
        # print('temporal pts:', tmp_pts)
